...
def load_model(model_path, device="npu", **kwargs):
...
def generate(args):
    ...
    inputs = tokenizer(input_txt, return_tensors="pt").to(f'npu:{DEVICE_ID}')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--device", type=str, default="npu:0", help="Set the device")
    parser.add_argument(
        "--max_new_tokens",
        type=int,
        default=512,
