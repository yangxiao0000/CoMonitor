...
PRETRAINED_MODEL_PATH="/root/.cache/modelscope/hub/models/colossalai/Colossal-LLaMA-2-7b-base"
...
declare -a dataset=(
    "/root/000030/llama2_npu/dataset/arrow/part-00000"
    "/root/000030/llama2_npu/dataset/arrow/part-00001"
)
...
colossalai run --nproc_per_node 2 --master_port 29688  train_npu_monitor.py \
